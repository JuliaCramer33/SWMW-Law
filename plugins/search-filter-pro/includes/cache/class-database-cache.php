...
class Database_Cache {
	...
	public static function get( $key, $group, $format = 'auto', &$found = null ) {
		...
		return self::decode_value( $row->cache_value, $row->format, $format );
	}
	 ...
	 * @param string $expected_format Expected format mode ('auto' or 'raw').
	 * @return mixed Decoded value.
	 */
	private static function decode_value( $stored_value, $stored_format, $expected_format ) {
