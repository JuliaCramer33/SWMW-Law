...
class Remote_Notices {
	...
	public static function init() {
		...
		// Create the schedule.
		// @codingStandardsIgnoreStart - Custom interval is intentional for remote notice checks
	...
	public static function fetch() {
		...
		if ( empty( $notice_response ) ) {
			Options::update( self::OPTION_NOTICES, array() );
			return;
		}
		...
		Options::update( self::OPTION_NOTICES, $notice_response );
	}

	/**
	 * Validate a notice response.
	 *
	 * @since 3.0.0
	 *
	 * @param array $notice The notice to validate.
	 * @return array|false The validated notice or false on failure.
	 */
	...
	public static function display_search_filter_notices() {
		...
		$remote_notices = \Search_Filter\Options::get( self::OPTION_NOTICES );
