...
class Range extends \Search_Filter\Fields\Range {
	...
	private function format_range_value( $values ) {
		...
		$from = $value_prefix . number_format( $from, $decimals, $decimal_character, $thousands_character ) . $value_suffix;
		$to   = $value_prefix . number_format( $to, $decimals, $decimal_character, $thousands_character ) . $value_suffix;
